...
mt{
    ...
    title = '暴风雪',
    tip = [[
		主动：在周围 %hit_area% 码降下大范围的暴风雪，每1秒造成 攻击力*1+智力*2点 法术伤害( %damage% )，并晕眩 %yun_time% 秒，并额外增加 %defence_rate% %护甲 ，持续 %time% 秒。同时刷新寒冰护盾。
		
		被动1（寒冰护盾）：每 %pulse_time% 秒自身获得一个护盾， 护盾可抵免 攻击力*1+智力*3点 伤害 (%shield%) ，寒冰护盾最多存在1个；
