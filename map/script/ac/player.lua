...
--结盟
	...
	function mt:setAllianceSimple(dest, flag)
		...
		jass.SetPlayerAlliance(self.handle, dest.handle, jass.ConvertUnitState(3), flag)		--ALLIANCE_SHARED_XP
		jass.SetPlayerAlliance(self.handle, dest.handle, jass.ConvertUnitState(4), flag)		--ALLIANCE_SHARED_SPELLS
		jass.SetPlayerAlliance(self.handle, dest.handle, jass.ConvertUnitState(5), flag)		--ALLIANCE_SHARED_VISION
...
function mt:enableControl(dest, flag)
	jass.SetPlayerAlliance(dest.handle, self.handle, jass.ConvertUnitState(6), true)
	if flag then
